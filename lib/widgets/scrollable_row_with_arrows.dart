...
class _ScrollableRowWithArrowsState extends State<ScrollableRowWithArrows> {
  ...
  void _scrollLeft() => _controller.animateTo(
    (_controller.offset - widget.scrollAmount)
        .clamp(0.0, _controller.position.maxScrollExtent),
    duration: const Duration(milliseconds: 200),
    curve: Curves.easeInOut,
  );

  void _scrollRight() => _controller.animateTo(
    (_controller.offset + widget.scrollAmount)
        .clamp(0.0, _controller.position.maxScrollExtent),
    duration: const Duration(milliseconds: 200),
    curve: Curves.easeInOut,
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        // Force update scroll state on every build (e.g., resize)
